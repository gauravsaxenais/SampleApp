// <copyright file="JwtIssuerOptions.cs" company="SampleApp">
...
namespace SampleAppApi.DataAccess.Auth
{
  /// <summary>
  /// JwtIssuerOptions class: This class defines properties for a JW token.
  /// </summary>
