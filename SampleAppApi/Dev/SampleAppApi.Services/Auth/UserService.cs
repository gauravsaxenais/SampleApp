// <copyright file="UserService.cs" company="SampleApp">
  ...
  public class UserService : IUserService
  {
	...
	private static void CreatePasswordHash(string password, out byte[] passwordHash, out byte[] passwordSalt)
	{
	  ...
	  using (var hmac = new global::System.Security.Cryptography.HMACSHA512())
	  {
		...
		passwordHash = hmac.ComputeHash(global::System.Text.Encoding.UTF8.GetBytes(password));
	  }
	}
	...
	private static bool VerifyPasswordHash(string password, byte[] storedHash, byte[] storedSalt)
	{
	  ...
	  using (var hmac = new global::System.Security.Cryptography.HMACSHA512(storedSalt))
	  {
