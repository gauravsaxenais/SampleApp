...
export class SignalrService {
   ...
   */
  private leaveFloorMapStatusGroup() {
    this.proxy.invoke('LeaveGroup', 'MapStatusChanged_' + this.local.getSiteGuid() + '_' + this.local.getFloorMapId())
      .catch((error: any) => {
        console.log('broadcastMessage error -> ' + error);
      });
  }
