...
import { MonitoringFloorMapComponent } from './shared/monitoring-floor-map/monitoring-floor-map.component';
...
@NgModule({
  declarations: [MonitoringHeaderComponent, MonitoringLeftPanelComponent,
    ...
    MonitoringLayoutComponent, MonitoringFooterComponent, MonitoringSiteMapComponent, ChartOptionComponent, MonitoringSystemComponent, MonitoringFloorMapComponent, CameraPopupComponent],
  providers: [DatePipe],
  imports: [
    CommonModule,
  ...
  exports: [
    ...
    MonitoringAccessGrantedChartComponent, MonitoringEventComponent, MonitoringAccessPointComponent,
    MonitoringSiteMapComponent, MonitoringSystemComponent, TranslateModule, MonitoringFloorMapComponent, CameraPopupComponent
  ]
})
