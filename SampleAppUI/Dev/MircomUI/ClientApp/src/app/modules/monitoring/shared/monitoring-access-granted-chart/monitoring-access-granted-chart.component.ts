...
export class MonitoringAccessGrantedChartComponent implements OnInit, OnDestroy {
   ...
   */
  constructor(private httpService: HttpService, private dataService: DataService, private local: LocalStorageService, private translate: TranslateService) {
  }
        ...
        .then(
          ...
          (err: any) => {
            if (err.error != null && err.error.message != null) {
              swal({
                title: err.error.message.description,
                type: 'warning',
                confirmButtonClass: 'btn btn-success',
                confirmButtonText: ok.value,
                buttonsStyling: false
